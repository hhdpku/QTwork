/****************************************************************************
** Meta object code from reading C++ file 'adddldialog.h'
**
...
#error "The header file 'adddldialog.h' doesn't include <QObject>."
...
void AddDDLDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (_t _q_method = &AddDDLDialog::onMoodSliderValueChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void AddDDLDialog::onMoodSliderValueChanged(int _t1)
{
