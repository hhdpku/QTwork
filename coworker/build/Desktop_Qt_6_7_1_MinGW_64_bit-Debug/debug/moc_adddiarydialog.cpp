...
void AddDiaryDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->diaryAdded((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[3])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[4]))); break;
        ...
        {
            using _t = void (AddDiaryDialog::*)(const QString & , const QString & , int , QString );
...
// SIGNAL 0
void AddDiaryDialog::diaryAdded(const QString & _t1, const QString & _t2, int _t3, QString _t4)
{
