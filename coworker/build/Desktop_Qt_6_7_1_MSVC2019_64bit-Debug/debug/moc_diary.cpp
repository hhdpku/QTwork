...
struct qt_meta_stringdata_CLASSDiaryENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSDiaryENDCLASS = QtMocHelpers::stringData(
    "Diary",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSDiaryENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Diary::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSDiaryENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSDiaryENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDiaryENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Diary::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSDiaryENDCLASS.stringdata0))
